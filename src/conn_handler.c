...
static int stream_formatter(FILE *pipe, void *data, metric_type type, char *name, void *value) {
    ...
    included_counter_metrics_config* counters_config = &(GLOBAL_CONFIG->ext_counters_config);
    included_timer_metrics_config* timers_config = &(GLOBAL_CONFIG->timers_config);
